...
void welcome(Pointer<Telnet> telnet);
void login(Pointer<Telnet> telnet,char *line);
void password(Pointer<Telnet> telnet,char *line);
void name(Pointer<Telnet> telnet,char *line);
void blurb(Pointer<Telnet> telnet,char *line);
void process_input(Pointer<Telnet> telnet,char *line);
void erase_line(Pointer<Telnet> telnet);
void quit(int);
void alrm(int);
